...
int main()
{
    ...
    res = comb(items, selections);

    if (items < selections)
        res;

    else
        printf("\nThe number of combinations of %d items selected %d at a time is: %d", items, selections, res);
